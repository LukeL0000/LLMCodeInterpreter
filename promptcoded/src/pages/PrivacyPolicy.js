    ...
    return (
        <div className="privacy-policy">
            ...
            <div>
                ...
                <ul>
                    <li>Your profile information.
                        When you register with this platform, we collect information including your full name, username, and password.</li>
                    <li>Your attempts and results to the codes sample questions.
            ...
            <div>
                ...
                <br></br>
                The information we collect is to provide you and your instructor with your past scores and results.
                ...
                Your personal information including your name, username, and passwords will not be shared with any external organization.
            </div>
            <div>
